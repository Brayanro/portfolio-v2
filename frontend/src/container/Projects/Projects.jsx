...
const Projects = () => {
  ...
  const handleProjectFilter = (item) => {
    ...
    setTimeout(() => {
      ...
      item === 'Todo' ? setFilterProject(projects) : setFilterProject(projects.filter(project => project.tags.includes(item)))
    }, 500)
  }

  return (
    <>
      <h2 className='head-text'>Mis <span>Proyectos</span></h2>
      <div className='app__project-filter'>
        {['JavaScript', 'React', 'Todo'].map((item, index) => (
          <div
            key={index}
